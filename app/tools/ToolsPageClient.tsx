        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="text-lg px-8 border-white hover:bg-white hover:text-primary text-white bg-transparent"
            >
          ...
          <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
            <div className="p-3 bg-white/10 rounded-lg">
              <div className="font-semibold">Branding Tools</div>
              <div className="opacity-80">Domain, Logo, Colors</div>
            </div>
            <div className="p-3 bg-white/10 rounded-lg">
              <div className="font-semibold">Content Tools</div>
              <div className="opacity-80">Blog, Copy, Social Media</div>
            </div>
            <div className="p-3 bg-white/10 rounded-lg">
              <div className="font-semibold">Marketing Tools</div>
              <div className="opacity-80">SEO, Email, Analytics</div>
            </div>
            <div className="p-3 bg-white/10 rounded-lg">
              <div className="font-semibold">Business Tools</div>
              <div className="opacity-80">Planning, Invoicing, Proposals</div>
            </div>
          </div>
        </div>
      </section>
